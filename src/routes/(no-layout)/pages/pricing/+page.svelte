...
>
	<NavBrand href="/">
		<img src="/images/flowbite-svelte-icon-logo.svg" class="me-3 h-6 sm:h-9" alt="WeAllShare Logo" />
		<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">WeAllShare</span
		>
	</NavBrand>
	<NavHamburger />
